...
const Profile = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: 'john.doe@hahnsoftware.com',
        ...
        {!isEditing ? (
          ...
          <div className="flex space-x-3">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={handleSave}
              className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-xl flex items-center space-x-2 shadow-lg transition-colors"
            >
        ...
        >
          <div className="bg-white dark:bg-dark-card rounded-xl p-6 shadow-lg border border-light-border dark:border-dark-border">
            ...
            <div className="mt-8 pt-6 border-t border-light-border dark:border-dark-border">
              ...
              <button className="flex items-center space-x-2 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
